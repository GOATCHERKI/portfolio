...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      'service_zrdzva8',      // <-- replace with your EmailJS service ID
      'template_9n5p5qp',     // <-- replace with your EmailJS template ID
      e.target,
      'oBMUHZeEgpv1PAXQ0'       // <-- replace with your EmailJS public key
    )
    .then(() => {
  ...
  return (
    <div id="contact" className='w-full px-[12%] scroll-mt-20 snap-section bg-[url("/footer-bg-color.png)] bg-no-repeat bg-center bg-[length:90%_auto]'>
        <motion.h4 
          style={contactStyles.text} 
          className="text-center mb-2 text-lg font-mozilla-headline font-light"
        ...
        <motion.h2 
          style={contactStyles.text} 
          className="text-center text-5xl font-mozilla-headline font-medium"
        ...
        <motion.p 
          style={contactStyles.text} 
          className="text-center max-w-2xl mx-auto mt-5 mb-12 font-mozilla-text"
          variants={paragraphVariants}
          initial="hidden"
          animate={isVisible ? "visible" : "hidden"}
        >
           I'd love to hear from you! If you have any questions, comments or feedback, feel free to send it through!
        </motion.p>
        ...
        <div className='flex flex-col lg:flex-row items-center gap-12'>
          ...
          <motion.form 
            onSubmit={sendEmail}
            className="w-full max-w-2xl mx-auto lg:mx-0 lg:flex-1"
          ...
          >
              ...
              <button 
                  ...
                  className='py-3 px-8 w-max flex items-center justify-between gap-2 rounded-full mx-auto lg:mx-0 duration-500 hover:scale-105 hover:shadow-lg transition-all'
              >
              Submit now 
              </button>
              <div className="text-center mt-2 text-sm">{formStatus}</div>
          </motion.form>

          <StyledWrapper>
            <motion.div 
              className="section-banner ml-10 xl:ml-75"
