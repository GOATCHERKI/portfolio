...
export const workData = [
  {
    ...
    description: [
      ...
      "- Redux Toolkit: Centralized workspace/project/task state management.",
      "- Clerk: Authentication, user management, and organization/workspace identity.",
      "- Node.js & Express: REST API server and business logic layer.",
      "- Prisma ORM: Type-safe database access and relational modeling.",
      "- PostgreSQL: Persistent storage for users, workspaces, projects, tasks, and comments.",
      "- Inngest: Event-driven workflows for Clerk sync and task notifications.",
      "- Nodemailer: Email delivery for invitations and assignment alerts.",
      "- React Router: Client-side routing for dashboard, projects, team, and task detail pages.",
      "- Axios: API communication between frontend and backend.",
      "- React Hot Toast: User feedback notifications.",
      "Features:",
      "- Workspace Management: Create and manage workspaces with admin/member roles.",
      "- Team Collaboration: Invite members via email and sync memberships with Clerk organizations.",
      "- Project Operations: Create/update projects with status, priority, progress, timeline, and team lead assignment.",
      "- Task Lifecycle: Create, update, and bulk delete tasks with role-based permissions.",
      "- Project Views: Board, tasks list, calendar, analytics, and settings tabs.",
      "- Comments System: Task-level discussions for project members.",
      "- Role-Based Access: Workspace admins, project team leads, assignees, and members have scoped permissions.",
      "- Email + Event Workflows: Automated notifications for invitations and task assignments.",
      "- Responsive Dashboard: Optimized layouts for desktop and mobile workflows.",
      "Usage:",
      "- Admin: Create workspace/projects, invite members, and manage project structure.",
      "- Team Lead: Add project members, assign tasks, and track progress.",
      "- Member/Assignee: View assigned tasks, update task status, and collaborate through comments.",
      "- Invitation Flow: Users accept invites and are synced into workspace membership records.",
      "- Dashboard: Monitor workspace activity, project status, team participation, and task summaries."
    ],
    bgImage: "/work-project-bg.png",
    images: [
      "/work-project-1.png",
      "/work-project-4.png",
      "/work-project-2.png",
    ...
    githubLink: "https://github.com/GOATCHERKI/project_management",
    liveDemo: "https://project-management-system-rosy.vercel.app/"
  },{
    title: "Car Rental Platform",
    description: [
      "Smart Car Rental Website: A modern full-stack application for renting and managing vehicles, built with React, Node.js, and MongoDB.",
      "Tech Stack:",
      "- React 19: User interfaces for customer and car owner portals.",
      "- Vite: Fast frontend build tool with optimized production builds.",
      "- Tailwind CSS: Modern, responsive styling framework.",
      "- Framer Motion: Smooth animations and transitions.",
      "- Node.js & Express: Backend runtime and RESTful API server.",
      "- MongoDB & Mongoose: Database for storing users, cars, and bookings.",
      ...
      "Features:",
      "- Owner Portal: Add/edit car listings, manage inventory, track bookings, and view dashboard analytics.",
      "- Customer Portal: Browse available cars, view detailed specifications, book vehicles, and manage reservations.",
      "- Advanced Car Search: Filter by category, fuel type, transmission, seats, and location.",
      "- Booking System: Date-based reservations with automatic pricing calculation and availability checking.",
      "- Image Management: Secure car image uploads and optimization via ImageKit CDN.",
      "- Role-Based Access: Separate interfaces and permissions for car owners and customers.",
      "- Responsive Design: Fully optimized for desktop, tablet, and mobile devices.",
      "- User Authentication: Secure login/signup with JWT tokens and encrypted passwords.",
      "- Real-time Notifications: Toast notifications for bookings, confirmations, and errors.",
      "Usage:",
      "- Owner: Register as owner, add your cars with images and details, set pricing, and manage incoming bookings.",
      "- Customer: Browse car catalog, filter by preferences, view car details, and book for specific dates.",
      "- Booking Management: Customers can view and cancel their bookings; owners can confirm or reject requests.",
      "- Dashboard: Owners access analytics and overview of their fleet and booking statistics.",
      "- Profile: Users can update their information and view booking history.",
    ],
    bgImage: "/work-car-rental-bg.png",
    images: [
      "/work-car-9.png",
      "/work-car-8.png",
      "/work-car-7.png",
